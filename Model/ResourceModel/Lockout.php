...
namespace GhoSter\AccountShield\Model\ResourceModel;

class Lockout extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('ghoster_accountshield_lockout', 'id');
    }
}
